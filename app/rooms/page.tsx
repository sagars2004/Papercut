...
type RoomSummary = { id: string; name: string; invite_code: string; duration_days: number; status: "lobby" | "active" | "complete"; ends_at: string | null };
...
export default async function RoomsPage() {
  ...
  const { data } = await supabase.from("players").select("rooms(id, name, invite_code, duration_days, status, ends_at)").eq("user_id", user.id).order("joined_at", { ascending: false });
