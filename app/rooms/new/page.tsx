...
type NewRoomPageProps = {
  searchParams: Promise<{ duration?: string | string[]; roomName?: string | string[] }>;
};
...
export default async function NewRoomPage({ searchParams }: NewRoomPageProps) {
  ...
  const initialDurationDays = typeof query.duration === "string" ? Number(query.duration) : 7;
